...
INSERT INTO lot (name, lot_category, category, img_url, start_price, step, end_date, author, description, last_bet)
VALUES ('2014 Rossignol District Snowboard', 'Доски и лыжи', 1, 'img/lot-1.jpg', '10999', '100', '2019-06-30 23:50', 1, 'Test', NULL),
       ('DC Ply Mens 2016/2017 Snowboard', 'Доски и лыжи', 1, 'img/lot-2.jpg', '159999', '100', '2019-06-30 23:50', 2, 'Test', 160099),
       ('Крепления Union Contact Pro 2015 года размер L/XL', 'Крепления', 2, 'img/lot-3.jpg', '8000', '100', '2019-06-30', 3, 'Test', 8100),
       ('Ботинки для сноуборда DC Mutiny Charocal', 'Ботинки', 3, 'img/lot-4.jpg', '10999', '100', '2019-06-30', 2, 'Test', NULL),
       ('Куртка для сноуборда DC Mutiny Charocal', 'Одежда', 4, 'img/lot-5.jpg', '7500', '100', '2019-06-30', 1, 'Test', NULL),
       ('Маска Oakley Canopy', 'Разное', 6, 'img/lot-6.jpg', '350', '100', '2019-06-30', 3, 'Test', NULL);
